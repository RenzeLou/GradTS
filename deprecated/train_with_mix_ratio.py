...
def model_config(parser):
    ...
    parser.add_argument('--do_lower_case', action='store_true',help="just for lower case the model predictions")
...
def main():
    ...
    for train_dataset in train_datasets:
        sig_task_train_dataset = MultiTaskDataset([train_dataset])
        sig_task_batch_sampler = MultiTaskBatchSampler([train_dataset], args.batch_size, args.mix_opt, args.ratio,
                                                       bin_on=args.bin_on, bin_size=args.bin_size,
                                                       bin_grow_ratio=args.bin_grow_ratio)
        sig_task_train_data = DataLoader(sig_task_train_dataset, batch_sampler=sig_task_batch_sampler,
                                         collate_fn=train_collater.collate_fn, pin_memory=args.cuda)
