...
train_datasets="mnli,rte,qqp,qnli,mrpc,sst,cola,wnli"
test_datasets="mnli_matched,mnli_mismatched,rte,qqp,qnli,mrpc,sst,cola,wnli"
...
model_dir="checkpoints/8_${BERT_PATH}"
